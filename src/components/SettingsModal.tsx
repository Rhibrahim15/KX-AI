    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm theme-secondary">
          KX-AI respects your privacy. No data is sent anywhere except to the model providers you choose.
        </p>
      </div>
...
function DataTab() {
  ...
  const handleExport = () => {
    ...
    a.href = url
    a.download = `kx-ai-backup-${new Date().toISOString().split('T')[0]}.json`
    a.click()
    ...
    reader.onload = (event) => {
      try {
        ...
        if (typeof imported !== 'object' || imported === null) {
          throw new Error('Not a valid KX-AI export file.')
        }
    ...
    <div className="space-y-6">
      ...
      <div className="p-4 rounded-lg border border-theme-primary bg-theme-accent/50">
        ...
        <p className="text-sm theme-secondary leading-relaxed">
          KX-AI stores everything locally in this browser — conversations, memories, settings, API keys.
